...
import { FileText, Hourglass, Siren, ListChecks, Loader } from 'lucide-react';
...
export default function AdminDashboardPage() {
  ...
  const reportsQuery = useMemoFirebase(() => {
    ...
    // Department Admins see reports assigned to them
    if (isDepartmentAdmin(adminData.role)) {
  ...
  const reportStats = useMemo(() => {
    ...
    return {
      ...
      pending: adminData?.role === UserRole.SuperAdmin ? pendingReports.length : reports.filter(r => r.status === ReportStatus.Pending).length,
